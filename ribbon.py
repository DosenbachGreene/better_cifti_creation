...
def create(settings):
    ...
    os.system('wb_command -volume-label-import {0}/{1}.ribbon_222.nii.gz /mnt/FreeSurferAllLut.txt {0}/{1}.ribbon_222.nii.gz -discard-others -unlabeled-value 0'.format(Ribbon,sub))
